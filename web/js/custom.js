...
jQuery(document).ready(function () {
	...
	// btn track click
	jQuery('#track-it').on( "click", function() {
      if (jQuery('#track-number')[0].value == 'test'){
          jQuery('#section-tracking-error').hide();
      		jQuery('#section-tracking-result').slideDown();
      		jQuery('html,body').scrollTo("#section-tracking-result", "#section-tracking-result");
      }else{
        jQuery('#section-tracking-result').hide();
        jQuery('#section-tracking-error').slideDown();
        jQuery('html,body').scrollTo("#section-tracking-error", "#section-tracking-error");
      }
    });
